...
prop_smithNormalForm m =
  withMaxSuccess 500 $
    any (/= 0) m ==>
      let m' = smithNormalForm m in satisfiesDivisibilityCondition m' && isDiagonal m'
